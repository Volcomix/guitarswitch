...
class MidiPlugin : public Plugin {
        ...
        void append_note(uint8_t status, uint8_t note, uint8_t velocity);
    protected:
        LV2_Atom_Event* ev;

        void append_note_on(uint8_t channel, uint8_t note, uint8_t velocity);
        void append_note_off(uint8_t channel, uint8_t note, uint8_t velocity);
        void forward();
